# Pattern 5: Deep Research Agent with Sessions & Skills

**Last week, I needed to build a literature review agent that could compare three AI frameworks, accept user feedback, and refine its analysis. After trying manual prompt chaining and wrestling with state management, I discovered Claude Agent SDK's Sessions & Skills pattern.**

In 15 minutes, I had a working research agent that:
- Conducted multi-turn analysis with context preservation
- Loaded project instructions automatically (no manual prompting)
- Used domain expertise from skills files
- Accepted human feedback and refined its output

Here's how you can build the same thing—no complex state management required.
...
Here's the complete research agent in a single file:
...
### Pitfall 1: Forgetting web_search in allowed_tools
...
### Pitfall 2: Using Wrong session_id
...
### Pitfall 3: Not Setting Effort Level
...
### Pitfall 4: Missing settingSources
